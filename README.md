...
### 2. Install PyTorch
PyTorch is **not** included in `requirements.txt`. While other versions may work, we recommend aligning with **PyTorch 2.3.0 + CUDA 12.1** if you encounter dependency conflicts.
